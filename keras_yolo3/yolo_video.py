...
from yolov3_Helmet_Detection import Helmet_detection_YOLOV3 as hdy
import argparse
...
if __name__ == '__main__':
    ...
    if arguments.image:
        ...
        if "input" in arguments:
            print(" Ignoring remaining command line arguments: " + arguments.input + "," + arguments.output)
        detect_img(YOLO(**vars(arguments)), arguments.image)

    elif "input" in arguments:
        detect_video(YOLO(**vars(arguments)), arguments.input, arguments.output)
    else:
